...
from iep.application.fixtures import FixturesMixin
...
class IntegrationFixture(IAPFixturesMixin, FixturesMixin):
    SESSION_CACHE = {}
...
class ViewFixture(ViewFixtureMixin):
    ...
    def mget_user_id(self, view):
        with patch.object(view, "get_user_id", autospec=True):
            yield uuid4()
